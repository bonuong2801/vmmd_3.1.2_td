      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
              ...
              {messages.map((msg, i) => (
                ...
                >
                  ...
                  <div className={`max-w-[85%] p-5 rounded-3xl text-sm leading-relaxed shadow-sm ${
                    ...
                    : "bg-warm-bg text-ink rounded-tl-none border border-gold/20"
                  }`}>
                    <div className="markdown-body prose prose-sm max-w-none prose-stone">
            ...
            {/* Input */}
            <div className="p-6 bg-stone-50 border-t border-stone-200 relative z-10">
              <form 
              ...
              >
                <input
                  ...
                  className="w-full bg-white border border-stone-300 rounded-2xl py-4 pl-6 pr-16 text-base text-ink focus:ring-2 focus:ring-burgundy/20 focus:border-burgundy/40 transition-all placeholder:text-stone-400 font-serif"
                />
                <button
                  type="submit"
                  disabled={!input.trim() || isLoading}
                  className="absolute right-2 top-1/2 -translate-y-1/2 w-10 h-10 bg-burgundy text-white rounded-xl flex items-center justify-center hover:bg-lacquer disabled:opacity-30 disabled:hover:bg-burgundy transition-all shadow-sm"
                >
                  <Send size={16} />
                </button>
              </form>
